...
```{r}
retrieve_data(bp_list)
retrieve_data(bp_list,summary_stat="var")
retrieve_data(bp_list,summary_stat="sd")
retrieve_data(bp_list,summary_stat="min")
retrieve_data(bp_list,summary_stat="max")
```
